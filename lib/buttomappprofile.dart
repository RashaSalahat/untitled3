...
class BottomParProfile extends StatefulWidget {
  const BottomParProfile({Key? key}) : super(key: key);
  // final String title;
  @override
  State<BottomParProfile> createState() => _BottomParProfileState();
}

class _BottomParProfileState extends State<BottomParProfile> {
  // bg color
  Color bgColor = const Color(0XFF214283); //Colors.black;

  int _page = 3; //current page index
