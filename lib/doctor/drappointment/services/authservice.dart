...
class AuthServicedoctor {
  ...
  accept(status, date) async {
    return await dio.post('http://10.0.2.2:3000/acceptApp/Rana/Rasha',
        data: {"status": status, "date": date},
        options: Options(contentType: Headers.formUrlEncodedContentType));
  }

  cancel(status, date) async {
    return await dio.post('http://10.0.2.2:3000/cancelApp/Rana/Rasha',
        data: {"status": status, "date": date},
        options: Options(contentType: Headers.formUrlEncodedContentType));
  }
